...
![License](https://img.shields.io/github/license/sr00t3d/cpanel-create-mail) ![Shell Script](https://img.shields.io/badge/language-Bash-green.svg) ![Compatibility](https://img.shields.io/badge/compatible-cpanel-blue)
...
```bash
./cp-create-email.sh email@domain.com
```
